        ...
        <div id="layoutSidenav" style="display: flex; background-color: #eee;">
            ...
            <div style=" margin: 110px 0 50px; background-color: white; padding: 56px 100px 0;border-radius: 30px;" class="col-sm-5">
                <form action="admin-add-product" id="add-form" method="POST">
                    ...
                    <button id="add-model" style="background-color: #FF939C; margin:12px 150px; border: none; padding: 12px 20px" type="button" onclick="addModel()">Add Model</button>
                    <hr style="color: #000 !important" style="width: 40px !important">
                    <div>
                        <button id="add-product" style="background-color: #FF4C4C; margin:16px 120px 16px" value="Add product" onclick="filterEmpty()">Add Product</button>
                    </div>
                </form>
            </div>
        </div>     
