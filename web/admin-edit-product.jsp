        ...
        <div id="layoutSidenav" style="display: flex; background-color: #eee;">
            ...
            <div style=" margin: 110px 0 50px; background-color: white; padding: 56px 72px 0;border-radius: 30px; width: 63%" >
                <form action="admin-edit-product" id="add-form" method="POST">
                    ...
                    <button style="background-color: #FF939C; margin:16px 360px 8px;  padding: 12px 20px; border: none">Save</button>
                    </form>
                    ...
                    <div class="cart-view-area" >
                        <div class="cart-view-table">
                            <div class="table-responsive">
                                <button style="background-color: #FFDFE0; margin:4px 0 4px; padding: 12px 20px; float: right; color: black" onclick="window.location.href ='admin-add-productmodel?product-id='+${product.id}" >Add New</button>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${product.getProductModel()}" var="pm">
                                            <tr>
                                                ...
                                                <td>${pm.quantity}</td>
                                                <td>
                                                    <button type="button" onclick="window.location.href = 'admin-edit-productmodel?id='+${pm.id}" class="btn" style="background-color: #fa8a93; color: white;">Edit</button>
                                                    <button type="button" onclick="doDelete('${pm.id}')" class="btn" style="background-color: #fa8a93cb; color: white;">Delete</button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
